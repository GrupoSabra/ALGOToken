...
{
    public class AlgoStreamResetStreamCommand : EthInvokeTransactionalFunctionCommand
    {
        public string NewStreamHolderAddress { get; set; }
        ...
        protected override async Task<TransactionReceipt> ExecuteAsync(RuntimeContext context, string contractAddress, Web3 web3)
        {
            ...
            return await algoStream.ResetStreamAsync(
                context.ResolveAccountReference(NewStreamHolderAddress),

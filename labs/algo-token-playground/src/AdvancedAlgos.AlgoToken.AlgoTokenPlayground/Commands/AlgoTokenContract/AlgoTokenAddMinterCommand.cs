...
{
    public class AlgoTokenAddMinterCommand : EthInvokeTransactionalFunctionCommand
    {
        ...
        protected override async Task<TransactionReceipt> ExecuteAsync(RuntimeContext context, string contractAddress, Web3 web3)
        {
            ...
            return await algoToken.AddMinterAsync(context.ResolveAccountOrContractReference(Account));
        }
    }
}

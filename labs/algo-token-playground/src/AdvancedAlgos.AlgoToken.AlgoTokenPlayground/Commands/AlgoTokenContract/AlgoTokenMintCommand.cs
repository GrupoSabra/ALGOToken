...
{
    public class AlgoTokenMintCommand : EthInvokeTransactionalFunctionCommand
    {
        ...
        protected override async Task<TransactionReceipt> ExecuteAsync(RuntimeContext context, string contractAddress, Web3 web3)
        {
            ...
            return await algoToken.MintAsync(context.ResolveAccountOrContractReference(To), Value);
        }
    }
}

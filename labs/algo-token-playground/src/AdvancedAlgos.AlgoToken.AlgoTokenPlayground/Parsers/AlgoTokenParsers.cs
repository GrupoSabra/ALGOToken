...
namespace AdvancedAlgos.AlgoToken.AlgoTokenPlayground.Parsers
{
    public static class AlgoTokenParsers
    {
        public static void Register()
        {
            ...
            (from contractReference in CommonParsers.Invoke("algotoken-totalsupply")
             select new AlgoTokenTotalSupplyCommand
             {
            ...
            (from contractReference in CommonParsers.Invoke("algotoken-addminter")
             from account in CommonParsers.StringValue
             select new AlgoTokenAddMinterCommand
             {
                 ContractReference = contractReference,
                 Account = account
             }).Register();

            (from contractReference in CommonParsers.Invoke("algotoken-mint")
             from to in CommonParsers.StringValue
             from value in EthUnitParsers.EthValue
             select new AlgoTokenMintCommand
             {
                 ContractReference = contractReference,
                 To = to,
                 Value = value
            ...
            (from contractReference in CommonParsers.Invoke("algotoken-isminter")
             from account in CommonParsers.StringValue
             select new AlgoTokenIsMinterCommand
             {
                 ContractReference = contractReference,
                 Account = account
             }).Register();

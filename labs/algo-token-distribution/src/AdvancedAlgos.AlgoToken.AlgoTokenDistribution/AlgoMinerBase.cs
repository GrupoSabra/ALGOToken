...
{
    public class AlgoMinerBase : SmartContract<AlgoMinerBase>
    {
        ...
        public AlgoMinerBase(Web3 web3, IGasPriceProvider gasPriceProvider) : base(web3, gasPriceProvider) { }
        public AlgoMinerBase(string contractAddress, Web3 web3, IGasPriceProvider gasPriceProvider) : base(contractAddress, web3, gasPriceProvider) { }

        protected override string AbiResourceName => $"SmartContracts.src.bin.AlgoMiner.abi";
        protected override string BinResourceName => $"SmartContracts.src.bin.AlgoMiner.bin";
